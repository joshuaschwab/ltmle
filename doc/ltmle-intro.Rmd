...
## Minimal Example
Consider the observed data with time ordering W -> A -> Y. W is a continous baseline covariate that affects A and Y. A is a binary treatment variable that affects Y. Y is a binary outcome variable. 
...
The `id` argument can be used to specify hierachical data, such as people in a household.
```{r}
num.households <- 500
