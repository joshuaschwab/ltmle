...
Without considering deterministic knowledege of A1 and A2:
```{r}
...
Now we use deterministic.g.function to include our deterministic knowledege of A1 and A2:
``` {r}
...
* det.Q.fun doesn't condition on called.from.estimate.g so g will also be set       deterministically after L2 > 0 
